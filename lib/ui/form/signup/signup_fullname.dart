            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      checkText ? Icon(Icons.cancel, color: Color.fromARGB(255, 150, 10, 0), size: 17) : SizedBox(),
                      Text(" This Phone Number has been used, Please try again!", style: TextStyle(color: Color.fromARGB(255, 150, 10, 0),fontSize: 10),),
                    ],
                  ),
                ),
