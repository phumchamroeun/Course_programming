...
import 'package:course_programming/UI/Form/Signup/signup.dart';
import 'package:course_programming/UI/Homepage/homepage.dart';
            ...
            child: Padding(
              ...
              children:[
                ...
                Container(
                 ...
                 // child: Image.asset("img/Logo_CarKH.png",fit: BoxFit.cover,),
                ),
                 SizedBox(
                  height: 10.0,
                ),
                ...
                Container(
                  ...
                  height: 30.0,
                  width: double.infinity,
                  child: Text("Wellcome to Course",style: TextStyle(
                    fontSize: 15,     
                  ),
                  ),
                ),
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: _validate==true?Text(""):Text('Unvalid Username or Password Try Again!',style: TextStyle(color: Colors.red,fontSize: 12,fontWeight: FontWeight.bold),),
                      )
                    ],
                  ),
                ),        
                            ...
                            child: Row(
                              children: [
                                ...
                                decoration: BoxDecoration(
                                 ...
                                 // child: Image.asset("img/Google_CarKH.jpg",fit: BoxFit.cover,),
                                ),
                                Expanded(
                 ...
                 Container(
                   child: Row(
                    ...
                    children: [
                      ...
                      child: Text("Sign Up",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Color(0xFF674AEF)),))
                    ],
                   ),
                 )
                ],
